...
return [
	...
	"usercompanies" => [
	"already_exists" => "That Usercompany already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Usercompany. Please try again.",
	"delete_error" => "There was a problem deleting this Usercompany. Please try again.",
	"not_found" => "That Usercompany does not exist.",
	"update_error" => "There was a problem updating this Usercompany. Please try again.",
	],
	"applicationmodules" => [
	"already_exists" => "That Applicationmodule already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Applicationmodule. Please try again.",
	"delete_error" => "There was a problem deleting this Applicationmodule. Please try again.",
	"not_found" => "That Applicationmodule does not exist.",
	"update_error" => "There was a problem updating this Applicationmodule. Please try again.",
	],
	"companyapps" => [
	"already_exists" => "That Companyapp already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Companyapp. Please try again.",
	"delete_error" => "There was a problem deleting this Companyapp. Please try again.",
	"not_found" => "That Companyapp does not exist.",
	"update_error" => "There was a problem updating this Companyapp. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://eslmaster.dom/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",

...
return [
	...
	"usercompanies" => [
	"all" => "All Usercompanies",
	"create" => "Create Usercompany",
	"edit" => "Edit Usercompany",
	"management" => "Usercompany Management",
	"main" => "Usercompanies",
	],
	"applicationmodules" => [
	"all" => "All Applicationmodules",
	"create" => "Create Applicationmodule",
	"edit" => "Edit Applicationmodule",
	"management" => "Applicationmodule Management",
	"main" => "Applicationmodules",
	],
	"companyapps" => [
	"all" => "All Companyapps",
	"create" => "Create Companyapp",
	"edit" => "Edit Companyapp",
	"management" => "Companyapp Management",
	"main" => "Companyapps",
	],
	],
	"language-picker" => [

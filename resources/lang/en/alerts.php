...
return [
	...
	"modules" => [
	"created" => "The Module was successfully created.",
	"deleted" => "The Module was successfully deleted.",
	"updated" => "The Module was successfully updated.",
	],
	"usercompanies" => [
	"created" => "The Usercompany was successfully created.",
	"deleted" => "The Usercompany was successfully deleted.",
	"updated" => "The Usercompany was successfully updated.",
	],
	"applicationmodules" => [
	"created" => "The Applicationmodule was successfully created.",
	"deleted" => "The Applicationmodule was successfully deleted.",
	"updated" => "The Applicationmodule was successfully updated.",
	],
	"companyapps" => [
	"created" => "The Companyapp was successfully created.",
	"deleted" => "The Companyapp was successfully deleted.",
	"updated" => "The Companyapp was successfully updated.",
	],
	],
];
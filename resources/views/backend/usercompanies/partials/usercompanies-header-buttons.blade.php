<!--Action Button-->
@if( Active::checkUriPattern( 'admin/usercompanies' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.usercompanies.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.usercompanies.all' ) }}
            </a>
        </li>
        @permission( 'create-usercompany' )
            <li>
                <a href="{{ route( 'admin.usercompanies.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.usercompanies.create' ) }}
                </a>
            </li>
        @endauth
    </ul>

<!--Action Button-->
@if( Active::checkUriPattern( 'admin/countries' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.countries.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.countries.all' ) }}
            </a>
        </li>
        @permission( 'create-country' )
            <li>
                <a href="{{ route( 'admin.countries.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.countries.create' ) }}
                </a>
            </li>
        @endauth
    </ul>

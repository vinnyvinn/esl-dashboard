        ...
        <div class="box-body">
            <div class="table-responsive data-table-wrapper">
                <table id="modules-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>{{ trans('labels.backend.modules.table.id') }}</th>
                            <th>{{ trans('labels.backend.modules.table.createdat') }}</th>
    ...
    <script>
        ...
        $(function() {
            var dataTable = $('#modules-table').dataTable({
                ...
                columns: [
                    {data: 'id', name: '{{config('module.modules.table')}}.id'},
                    {data: 'created_at', name: '{{config('module.modules.table')}}.created_at'},

<!--Action Button-->
@if( Active::checkUriPattern( 'admin/companyapps' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.companyapps.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.companyapps.all' ) }}
            </a>
        </li>
        @permission( 'create-companyapp' )
            <li>
                <a href="{{ route( 'admin.companyapps.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.companyapps.create' ) }}
                </a>
            </li>
        @endauth
    </ul>

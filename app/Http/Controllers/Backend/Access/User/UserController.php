...
class UserController extends Controller
{
    ...
    public function usercompany(CreateCompanyRequest $request)
    {
        return view('admin.access.user.usercompany')
            ->withCompanies($this->companies->getAll())
     ...
     * @return mixed
     */
    public function storecompany(StoreRoleRequest $request)
    {
